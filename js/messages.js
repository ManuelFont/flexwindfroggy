var messages = {
  ...
  labelAttribution: {
    ...
    es: 'Juego <a href="https://flexboxfroggy.com/" target="_blank" rel="noopener noreferrer">Flexbox Froggy</a> original e ilustraciones de Thomas Park · <a href="LICENSE">Licencia MIT</a> · <a href="https://creativecommons.org/licenses/by/3.0/" target="_blank" rel="noopener noreferrer">CC BY 3.0</a>.',
  },
  labelLicense: {
    en: "MIT License",
    es: "Licencia MIT",
  ...
  title: {
    en: "Flexwind Froggy - A game for learning Tailwind CSS Flexbox",
    es: "Flexwind Froggy - Un juego para aprender Flexbox con Tailwind CSS",
  },
  labelReset: {
    en: "Reset",
    es: "Reiniciar",
  ...
  gridGarden: {
    en: "Want to learn more Tailwind CSS? Play",
    es: "¿Quieres aprender más Tailwind CSS? Juega a",
  },
  labelLanguage: {
    en: "Language",
    es: "Idioma",
  ...
  labelDifficultyMedium: {
    ...
    es: "Intermedio: sin instrucciones",
  },
  labelDifficultyHard: {
    en: "Expert - No Directions & Random Levels",
    es: "Experto: sin instrucciones y niveles aleatorios",
  },
};
