var messages = {
  ...
  labelFooter: {
    ...
    'af': 'Flexwind Froggy is ontwerp deur',
    'he': 'Flexwind Froggy נוצר על ידי',
    'ro': 'Flexwind Froggy este creat de',
    'sr': 'Flexwind Froggy је направио',
    'bs': 'Flexwind Froggy je napravio',
    'hr': 'Flexwind Froggy je stvorio',
    'bg': 'Flexwind Froggy е създадена от',
    'de': 'Flexwind Froggy wurde gemacht von',
    'fr': 'Flexwind Froggy est créé par',
    'pt-br': 'Flexwind Froggy foi criado por',
    'es': 'Flexwind Froggy es una creación de',
    'ru': 'Игра Flexwind Froggy создана',
    'fa': 'قورباغه فلکس باکس ساخته شده توسط',
    'zh-cn': 'Flexwind Froggy的作者是',
    'zh-tw': 'Flexwind Froggy的作者是',
    'tr': 'Flexwind Froggy\'nin yaratıcısı:',
    'az': 'Flexwind Froggy\'nin qurucusu:',
    'it': 'Flexwind Froggy è stato creato da',
    'ko': 'Flexwind Froggy는 다음에 의해 개발되었습니다',
    'lt': 'Flexwind Froggy kūrėjas',
    'vi': 'Flexwind Froggy được tạo ra bởi',
    'pl': 'Flexwind Froggy jest wytworem',
    'cs': 'Flexwind Froggy vytvořil',
    'ja': 'Flexwind Froggy is created by',
    'hu': 'A Flexwind Froggy-t készítette',
    'eo': 'Flexwind Froggy far',
    'sv': 'Flexwind Froggy skapades av',
    'uk': 'Гру Flexwind Froggy створено',
    'hi': 'Flexwind Froggy के निर्माणकर्ता ',
    'gj': 'Flexwind Froggy ના નિર્માણકર્તા ',
    'nl': 'Flexwind Froggy is gemaakt door',
    'ta': 'Flexwind Froggy உருவாக்கியவர்',
    'te': 'Flexwind Froggy చేసిన వారు',
    'ml': 'Flexwind Froggy സൃഷ്ടിച്ചത്',
    'el': 'Το Flexwind Froggy δημιουργήθηκε από',
    'mk': 'Flexwind Froggy е создадено од',
    'lv': 'Flexwind Froggy autori ir',
    'id': 'Flexwind Froggy dibuat oleh',
    'ar': 'تم انشاء فروغي فلكسبكس بواسطة',
    'ca': 'Flexwind Froggy és una creació de',
    'da': 'Flexwind Froggy er skabt af',
    'et': 'Flexwind Froggy on looja on',
    'fi': 'Flexwind Froggyn on tehnyt',
    'gl': 'Flexwind Froggy creouno',
    'th': 'Flexwind Froggy ถูกสร้างโดย',
    'mn': 'Flexwind Froggy is created by',
    'sk': 'Flexwind Froggy vytvoril',
    'si': 'Flexbox මැඬියා නිර්මාණය කළේ',
    'bn': 'Flexwind Froggy তৈরি করেছে',
    'np': 'Flexwind Froggy को निर्माता',
    'my': 'Flexwind Froggy ကို ဖန်တီးခဲ့သည်',
    'yo': 'Àwọn tó dá ẹ̀dá Flexwind Froggy ní',
    'no': 'Flexwind Froggy er laget av',
  },
  labelLevel: {
    'en': 'Level',
    'af': 'Vlak',
  ...
  title: {
    ...
    'af': 'Flexwind Froggy - `n Spel vir die leer van CSS flexbox',
    'he': 'Flexwind Froggy - משחק ללמידת CSS flexbox',
    'ro': 'Flexwind Froggy - Un joc pentru a învăța CSS flexbox',
    'sr': 'Flexwind Froggy - Игра за учење CSS flexbox-а',
    'bs': 'Flexwind Froggy - Igra za učenje CSS flexbox-a',
    'hr': 'Flexwind Froggy - Igra za učenje CSS flexboxa',
    'bg': 'Flexwind Froggy - Игра за учене на CSS flexbox',
    'de': 'Flexwind Froggy - Ein Spiel, um CSS flexbox zu lernen',
    'fr': 'Flexwind Froggy - Un jeu pour apprendre les flexbox CSS',
    'pt-br': 'Flexwind Froggy - Um jogo para aprender CSS flexbox',
    'es': 'Flexwind Froggy - Un juego para aprender CSS flexbox',
    'ru': 'Flexwind Froggy - игра для изучения CSS flexbox',
    'fa': 'قورباغه فلکس باکس - یک بازی جذاب برای آموزش سی اس اس فلکس باکس',
    'zh-cn': 'Flexwind Froggy - 一个用来学CSS flexbox的游戏',
    'zh-tw': 'Flexwind Froggy - 一個用來學CSS flexbox的遊戲',
    'tr': 'Flexwind Froggy - CSS flexbox için öğretici oyun',
    'az': 'Flexwind Froggy - CSS flexbox üçün öyrədici oyun',
    'it': 'Flexwind Froggy - Un gioco per imparare CSS flexbox',
    'ko': 'Flexwind Froggy - CSS flexbox 속성 배우기 게임',
    'lt': 'Flexwind Froggy - Žaidimas padėsiantis perprasti CSS "flexbox" metodiką',
    'vi': 'Flexwind Froggy - Một trò chơi để học CSS flexbox',
    'pl': 'Flexwind Froggy - Gra wprowadzająca do CSS flexbox"',
    'cs': 'Flexwind Froggy - CSS flexbox hrou',
    'ja': 'Flexwind Froggy - CSS flexbox学習ゲーム',
    'hu': 'Flexwind Froggy - Játékos CSS flexbox tanulás',
    'eo': 'Flexwind Froggy - Ludo por lerni CSS flexbox-on',
    'sv': 'Flexwind Froggy - Ett spel för att lära sig CSS flexbox',
    'uk': 'Flexwind Froggy - гра для вивчення CSS flexbox',
    'hi': 'Flexwind Froggy - CSS Flexbox सीखने के लिए एक खेल',
    'gj': 'Flexwind Froggy - CSS Flexbox  શીખવા માટેની એક રમત',
    'nl': 'Flexwind Froggy - Een spel om CSS flexbox te leren',
    'ta': 'Flexwind Froggy - CSS flexbox கற்றல் விளையாட்டு',
    'te': 'Flexwind Froggy - CSS Flexbox నేర్చుకోవడానికి ఒక ఆట',
    'ml': 'Flexwind Froggy - CSS Flexbox പഠിക്കാം',
    'el': 'Flexwind Froggy - Ένα παιχνίδι για την εκμάθηση του CSS Flexbox',
    'mk': 'Flexwind Froggy - Игра за учење на CSS flexbox',
    'lv': 'Flexwind Froggy - Spēle, kas Tev palīdzēs iemācīties CSS Flexbox',
    'id': 'Flexwind Froggy - Sebuah permainan untuk belajar CSS flexbox',
    'ar': 'فروغي فلكسبكس - لعبة لتعلم الفلكسبكس في CSS',
    'ca': 'Flexwind Froggy - Un joc per aprendre CSS Flexbox',
    'da': 'Flexwind Froggy - Et spil, der lærer dig CSS Flexbox',
    'et': 'Flexwind Froggy - Mäng CSS flexbox\'i õppimiseks',
    'fi': 'Flexwind Froggy - Peli, jossa opit CSS flexbox -asettelun',
    'gl': 'Flexwind Froggy - Un xogo para aprenderes CSS Flexbox',
    'th': 'Flexwind Froggy - เกมสำหรับเรียนรู้ CSS Flexbox',
    'mn': 'Flexwind Froggy - CSS flexbox-г сурах тоглоом',
    'sk': 'Flexwind Froggy - Hra na učenie CSS flexbox',
    'si': 'Flexbox මැඬියා - CSS flexbox ඉගෙනීමේ ක්‍රීඩාවක්',
    'bn': 'Flexwind Froggy - CSS flexbox শেখার একটি গেইম',
    'np': 'Flexwind Froggy - CSS Flexbox सिक्नको लागि एउटा खेल',
    'my': 'Flexwind Froggy - CSS flexbox သင်ယူရန် ဂိမ်းတစ်ခု',
    'yo': 'Flexwind Froggy - Eré tí ẹ̀yàń lè fi kọ́ ẹ̀kọ́ flexbox CSS',
    'no': 'Flexwind Froggy - Et spill for å lære CSS flexbox'
  },
  labelReset: {
    'en': 'Reset',
    'af': 'Herstel',
